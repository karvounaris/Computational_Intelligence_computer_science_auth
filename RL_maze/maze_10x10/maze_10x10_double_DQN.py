...
from maze_env_10x10 import GridEnvironment_1
# from maze_agent_10x10 import DQNCNN
# from maze_agent_10x10 import DuelingDQNCNN
from maze_agent_10x10 import InceptionDQNCNN
...
agent = InceptionDQNCNN().to(device)
target_agent = InceptionDQNCNN().to(device)
